...
<div style="display: flex; gap: 20px; overflow-x: auto; padding-bottom: 20px;">
    <img src="/assets/images/screenrest/it/1.png" alt="Timer per le pause ScreenRest" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/it/2.png" alt="Metodi per intervalli di lavoro e riposo" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/it/3.png" alt="Tempi personalizzati" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/it/4.png" alt="Prevenzione dell'affaticamento visivo 20-20-20" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/it/5.png" alt="Pianificazione automatica delle pause" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
</div>
