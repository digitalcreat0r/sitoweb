...
<div style="display: flex; gap: 20px; overflow-x: auto; padding-bottom: 20px;">
    <img src="/assets/images/screenrest/en/1.png" alt="ScreenRest break timer" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/en/2.png" alt="Work and rest interval methods" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/en/3.png" alt="Customizable Times" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/en/4.png" alt="20-20-20 eye strain prevention" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
    <img src="/assets/images/screenrest/en/5.png" alt="Automated screen break scheduling" style="height: 400px; border-radius: 12px; box-shadow: var(--shadow);">
</div>
...
Working without breaks is the enemy of performance. It leads to mental fatigue and a sharp decline in output quality.<br>ScreenRest enforces scientifically backed rhythms to protect your cognitive energy:

* **Balanced Flow:** 52 minutes of focused work followed by a 17-minute recovery window.
* **Deep Focus:** high-intensity 90-minute work cycles.
...
**Work in the flow, take smarter breaks.**