...
lang: it
---
# Termini di Utilizzo - CleverPocket Dev

*Ultimo aggiornamento: 4 Maggio 2026*

Utilizzando il sito web, le applicazioni e i servizi forniti da **CleverPocket Dev** (lo "Sviluppatore"), accetti i seguenti termini. Ti preghiamo di leggerli attentamente.

## 1. Accettazione dei Termini
Accedendo al nostro sito web o scaricando e utilizzando le nostre applicazioni mobili, incluso **ScreenRest**, accetti di essere vincolato dai presenti Termini di Utilizzo e dalla nostra Informativa sulla Privacy.

## 2. Licenza e Utilizzo
Ti concediamo una licenza personale, non trasferibile e non esclusiva per utilizzare il nostro sito web e le nostre app per scopi personali e non commerciali. Accetti di non:
...
- **Raccolta Dati e Scopo:**<br>Per partecipare al programma, accetti di fornire il tuo indirizzo email (nello specifico, l'indirizzo associato al tuo account Google Play). Questi dati saranno trattati dallo Sviluppatore esclusivamente per:
    - Fornire l'accesso tecnico alle versioni di test tramite la Google Play Console.
    - Inviare comunicazioni strettamente operative riguardanti il test (es. aggiornamenti, segnalazione bug).
    - Gestire la distribuzione dei premi ottenuti.
...
## 8. Legge Applicabile
Questi termini sono regolati e interpretati in conformità con le leggi della giurisdizione dello Sviluppatore.

## 9. Informazioni di Contatto
In caso di domande su questi termini, contattami a: **{{ site.email }}**